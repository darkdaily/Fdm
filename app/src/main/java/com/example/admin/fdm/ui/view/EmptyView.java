package com.example.admin.fdm.ui.view;
...
public class EmptyView extends LinearLayout implements View.OnClickListener {
    ...
    public void setNodata(String msg,int imgResource){
        setNoDataImag(imgResource);
        setNoDataContent(msg);
        setErrorType(NODATA);
    }
    ...
    private boolean isLoadingNoData() {
        return mErrorState == NODATA;
    }

    //传入不同状态的图片 文字
    private void setErrorImag(int imgResource) {
        imgErrorImage = imgResource;
    }
    private void setErrorContent(String msg) {
        strErrorContent = msg;
    }

    private void setNoDataImag(int imgResource) {
        imgNoDataImage = imgResource;
    }
    private void setNoDataContent(String noDataContent) {
    ...
    public void setErrorType(int type) {
        ...
        switch (type) {
            ...
            case NODATA:
                ...
                img.setBackgroundResource(imgNoDataImage);
            ...
            case NETWORK_ERROR:
                animProgress.setVisibility(View.GONE);
                img.setImageResource(imgErrorImage == -1 ? R.drawable.no_netword : imgErrorImage);
                img.setVisibility(View.VISIBLE);
                tv.setText(strErrorContent == null ? "世界上最远的距离就是没网" : strErrorContent);
                tv.setVisibility(View.VISIBLE);
                setVisibility(View.VISIBLE);
                break;
            case HIDE_LAYOUT:
