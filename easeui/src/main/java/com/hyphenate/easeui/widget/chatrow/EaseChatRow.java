...
//                EaseUserUtils.setUserAvatar(context, EMClient.getInstance().getCurrentUser(), userAvatarView);
                String myHead = message.getStringAttribute("headImg","https://www.baidu.com/img/bd_logo1.png");
                Glide.with(getContext()).load(myHead).into(userAvatarView);
            } else {
                // TODO: 2017/11/2 修改聊天界面里面的用户头像和昵称
//                EaseUserUtils.setUserAvatar(context, message.getFrom(), userAvatarView);
                String headImageUrl = message.getStringAttribute("headImg","https://www.baidu.com/img/bd_logo1.png");
